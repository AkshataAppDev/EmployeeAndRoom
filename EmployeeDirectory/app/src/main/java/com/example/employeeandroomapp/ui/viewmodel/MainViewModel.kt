...
class MainViewModel @Inject constructor(private val directoryRepository: DirectoryRepository) :
    ViewModel() {
    ...
    val employee: LiveData<Employee> = Transformations.switchMap(_empId) { empId ->
